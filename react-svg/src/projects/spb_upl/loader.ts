...
export function make_project(project_data: ProjectSpec): ProjectInterface {
  ...
  console.log(
    pro
      .get_node("raw_materials_warehouse_control_system.inertUploadSystem.Jobs")
      ?.get_childrens()
  );
...
// type ProtoMap = { [key: string]: ProtoSpec };

// function map_protos(protos_list: ProtoSpec[]): ProtoMap {
//   return protos_list.reduce((map: ProtoMap, proto: ProtoSpec) => {
...
// function create_model(obj: ObjectSpec, proto: ProtoSpec): ModelInterface {
