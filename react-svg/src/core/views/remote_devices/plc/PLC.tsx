import { BlueGray, Emerald, Yellow } from "../../../nui/lib/palette";
...
export default function PLC({ x, y, hb_state, body_color = Emerald.p600 }: Props) {
  return (
    <g>
      {/* body */}
      <PC x={x} y={y} body_color={body_color} />
